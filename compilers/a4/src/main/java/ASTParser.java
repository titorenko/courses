...
class CUP$ASTParser$actions {
	...
	public final java_cup.runtime.Symbol CUP$ASTParser$do_action(
		...
		case 17: // expr ::= expr_aux COLON ID
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 16: // formalc ::= LINENO FORMAL ID ID
		{
			Formal RESULT = null;
			Integer l = (Integer) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 3)).value;
			...
			CUP$ASTParser$result = new java_cup.runtime.Symbol(9/* formalc */,
					RESULT);
		}
			return CUP$ASTParser$result;

			/* . . . . . . . . . . . . . . . . . . . . */
		case 15: // formalc_list ::= formalc_list formalc
		{
			Formals RESULT = null;
			...
			CUP$ASTParser$result = new java_cup.runtime.Symbol(
					8/* formalc_list */, RESULT);
		}
			return CUP$ASTParser$result;

			/* . . . . . . . . . . . . . . . . . . . . */
		case 14: // formalc_list ::= formalc
		{
			Formals RESULT = null;
			Formal f = (Formal) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 13: // formalcs ::= formalc_list
		{
			Formals RESULT = null;
			Formals fl = (Formals) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			RESULT = fl;
			CUP$ASTParser$result = new java_cup.runtime.Symbol(7/* formalcs */,
					RESULT);
		}
			return CUP$ASTParser$result;
		...
		case 11: // feature ::= LINENO ATTR ID ID expr
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 10: // feature ::= LINENO METHOD ID formalcs ID expr
		{
			Feature RESULT = null;
			Integer l = (Integer) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 5)).value;
				...
				// optional_feature_list RPAREN
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 4: // class_clist ::= class_clist class
		{
			Classes RESULT = null;
			Classes cl = (Classes) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			class_c c = (class_c) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			RESULT = cl.appendElement(c);
			CUP$ASTParser$result = new java_cup.runtime.Symbol(
					2/* class_clist */, RESULT);
		}
			return CUP$ASTParser$result;

			/* . . . . . . . . . . . . . . . . . . . . */
		case 3: // class_clist ::= class
		{
			Classes RESULT = null;
			class_c c = (class_c) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
		...
		case 2: // programc ::=
		{
			...
			RESULT = null;
			System.exit(1);
			CUP$ASTParser$result = new java_cup.runtime.Symbol(1/* programc */,
					RESULT);
		}
			return CUP$ASTParser$result;

			/* . . . . . . . . . . . . . . . . . . . . */
		case 1: // $START ::= programc EOF
		{
			Object RESULT = null;
			programc start_val = (programc) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			RESULT = start_val;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 0: // programc ::= LINENO PROGRAM class_clist
		{
			programc RESULT = null;
			Integer l = (Integer) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 2)).value;
